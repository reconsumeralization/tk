...
class Syntax(JupyterMixin):
    ...
    Args:
        ...
        word_wrap (bool, optional): Enable word wrapping. Defaults to False.
        background_color (str, optional): Optional background color, or None to use theme color. Defaults to "default".
    ...
    def __init__(
        ...
        *,
        ...
        self.code = code
        self._lexer = lexer or "default"
        self.dedent = dedent or False
        self.line_numbers = line_numbers or False
        self.start_line = start_line or 1
        self.line_range = line_range or (0, 0)
        self.highlight_lines = highlight_lines or set()
        self.code_width = code_width or 0
        self.tab_size = tab_size or 4
        self.word_wrap = word_wrap or False
        self.background_color = background_color or "default"
        self.background_style = (
            Style(bgcolor=background_color) if background_color else Style()
        )
        self.indent_guides = indent_guides or False

        self._theme = self.get_theme(theme or "default")
    ...
    def from_path(
        ...
        dedent: bool = False,
        line_numbers: bool = False,
        line_range: Optional[Tuple[int, int]] = (0, 0),
        start_line: int = 1,
        highlight_lines: Optional[Set[int]] = set(),
        code_width: Optional[int] = 0,
        tab_size: int = 4,
        word_wrap: bool = False,
        ...
        with open(path, "rt", encoding=encoding) as code_file:
            code = code_file.read() or ""

        lexer = None
        lexer_name = "default"
        try:
            _, ext = os.path.splitext(path or "default_path")
            if ext:
        ...
        if lexer is None:
            try:
                lexer_name = guess_lexer_for_filename(path or "default_path", code).name
            except ClassNotFound:
                pass
        ...
        return cls(
            ...
            dedent=dedent or False,
            line_numbers=line_numbers or False,
            line_range=line_range or (0, 0),
            start_line=start_line or 1,
            highlight_lines=highlight_lines or set(),
            code_width=code_width or 0,
            tab_size=tab_size or 4,
            word_wrap=word_wrap or False,
            background_color=background_color or "default",
            indent_guides=indent_guides or False,
        )
